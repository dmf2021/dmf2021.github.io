...
## [13] "log1p"                 "log2"                  "logb"                  "logDet"                "Logic"                 "logical"              
## [19] "logit"                 "logLik"                "loglin"                "pdLogChol"             "plogis"                "qlogis"               
## [25] "rlogis"                "SSlogis"
```
...
```
##   [1]  1.822269421  0.662605550  0.314133720 -0.910025756 -0.382569784 -0.462008315 -0.050671468 -0.640552236  0.904235273  2.393451734  0.781183730 -1.635691011
##  [13]  1.311241966  0.535093567  0.089923490  0.311046052  0.294459560  0.503898425 -0.233994447 -0.395106216 -0.002347721 -0.612988055  0.093344140 -3.048616157
##  [25] -1.395892417  0.777785499  0.001765263  0.711190295 -1.235801580 -0.340114809  0.215006442  0.784466678 -0.401834596 -1.095491637 -1.720073429 -0.004088029
##  [37]  0.355885945  0.746476434  0.801740491  2.664819720 -0.418926508 -0.323352476 -1.227681284 -0.065310009 -0.599080993 -0.647944135 -0.826343411  0.155416787
##  [49] -0.062579152  0.615597753  1.145692337  0.206721199 -1.808653616 -1.204501874 -0.348780379 -1.025700703 -0.907426272  0.774606657 -0.949897924 -1.243070075
##  [61]  0.391552445 -0.736440028  1.070957172  0.073410000  0.964760568  0.261434704 -0.209380898  1.287617593  0.814649343  0.091523998 -1.072033944 -0.511446648
##  [73]  0.256777174 -0.426945284 -0.349189989 -0.895852320  0.250568256 -0.286919473  1.267469822 -0.853420753 -0.615025027  0.895046866  0.725277685  1.287132557
##  [85]  0.682576210 -0.715396847  0.821865069 -0.424901246  1.467197615  1.462133364  1.534189990 -0.146072129 -0.461010239 -2.421945426  0.987432272  0.173908963
##  [97]  0.667841606 -0.204834872 -1.219522934 -1.419210066
```
...
```
## [1]  1.8222694  0.6626055  0.3141337 -0.9100258 -0.3825698 -0.4620083
```
...
## -3.048616 -0.621407 -0.003218 -0.017873  0.714712  2.664820
```
...
```
##  [1] -0.46200832 -0.05067147 -0.64055224  0.90423527  2.39345173  0.78118373 -1.63569101  1.31124197  0.53509357  0.08992349
```
...
```
## [1]  1.8222694  0.3141337 -0.3825698
```
...
```
##  [1]  1.82226942  0.66260555  0.31413372 -0.91002576 -0.38256978 -0.46200832 -0.05067147 -0.64055224  0.90423527  2.39345173
```
...
```
##  [1]  TRUE  TRUE FALSE  TRUE FALSE FALSE FALSE  TRUE  TRUE  TRUE
```
...
```
## [1]  1.8222694  0.6626055 -0.9100258 -0.6405522  0.9042353  2.3934517
```
...
```
##  [1] "Blackmore"      "bm.mod.1"       "bm.mod.2"       "bm.mod.3"       "bm.mod.5"       "bm.mod.6"       "con"            "Con.20"         "con.coef"      
## [10] "con.list"       "duncan.model"   "duncan.model.0" "duncan.model.2" "logical.values" "mod.cowles"     "mod.ornstein"   "mod.ornstein.1" "mod.ornstein.2"
## [19] "mod.ornstein.q" "myMean"         "mySD"           "pat"            "Pat.20"         "pat.coef"       "pat.list"       "Prestige.2"     "prestige.mod.1"
## [28] "prestige.mod.2" "prestige.mod.3" "prestige.mod.4" "prestige.mod.5" "prestige.mod.6" "tab"            "v"              "words"          "x"             
## [37] "y"              "z"
```
...
```
##  [1] "Blackmore"      "bm.mod.1"       "bm.mod.2"       "bm.mod.3"       "bm.mod.5"       "bm.mod.6"       "con"            "Con.20"         "con.coef"      
## [10] "con.list"       "duncan.model"   "duncan.model.0" "duncan.model.2" "mod.cowles"     "mod.ornstein"   "mod.ornstein.1" "mod.ornstein.2" "mod.ornstein.q"
## [19] "myMean"         "mySD"           "pat"            "Pat.20"         "pat.coef"       "pat.list"       "Prestige.2"     "prestige.mod.1" "prestige.mod.2"
## [28] "prestige.mod.3" "prestige.mod.4" "prestige.mod.5" "prestige.mod.6" "tab"
```
...
```
## 945 x 5 data.frame (925 rows omitted)
##     subject   age exercise   group log.exercise
##         [f]   [n]      [n]     [f]          [n]
## 1       100  8.00     2.71 patient    1.4819877
## 2       100 10.00     1.94 patient    1.0167340
## 3       100 12.00     2.36 patient    1.2888507
## 4       100 14.00     1.54 patient    0.6989593
## 5       100 15.92     8.63 patient    3.1232247
## 6       101  8.00     0.14 patient   -2.1627295
## 7       101 10.00     0.14 patient   -2.1627295
## 8       101 12.00     0.00 patient   -3.5849625
## 9       101 14.00     0.00 patient   -3.5849625
## 10      101 16.67     5.08 patient    2.3683027
## . . .                                               
## 763     284 14.00     0.00 control   -3.5849625
## 764     284 16.96     0.00 control   -3.5849625
## 765     285  8.00     0.72 control   -0.3159294
## 766     285 10.00     0.72 control   -0.3159294
## 767     285 13.21     1.54 control    0.6989593
## 768     286  8.00     1.10 control    0.2428565
## 769     286 10.00     1.10 control    0.2428565
## 770     286 12.00     0.35 control   -1.2064509
## 771     286 14.00     0.40 control   -1.0489096
## 772     286 17.00     0.29 control   -1.4214638
```
